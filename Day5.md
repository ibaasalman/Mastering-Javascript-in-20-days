...
// }
ratings = watchList.map(({Title,imdbRating})=>{
  return {
    title : Title,
    rating :imdbRating
  }
...
#### link : https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/functional-programming/use-the-filter-method-to-extract-data-from-an-array
...
filteredList = watchList.map(({Title,imdbRating})=>{
  return {
    title : Title,
    rating :imdbRating
  }
...
## #4 :  Golf Code
#### link : https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/basic-javascript/golf-code
